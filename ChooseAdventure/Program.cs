        ...
        static void Main(string[] args)
        {
            ...
            else if (noiseChoice == "YES")
            {
                Console.WriteLine("You walk into the hallway and see a light" +
                    "coming from under a door down the hall. You walk towards" +
                    "it. Do you open it or knock?");
                ...
                if (doorChoice == "KNOCK")
                {
                    Console.WriteLine("A voice behind the door speaks." +
                        ...
                        "it. Rich people need it. If you eat it you die. What is it?");
                ...
                {
                    Console.WriteLine("The door is locked! See if one of your three" +
                        "keys will open it.");
                    ...
                    switch (keyChoice)
                    {
                        ...
                        case "3":
                            Console.WriteLine("You choose the third key. The" +
                                "door doesn't open \n THE END");
                            break;
                        default:
                            Console.WriteLine("Erm you clearly cannot follow directions \n" +
                                "THE END");
                            break;
                    }
